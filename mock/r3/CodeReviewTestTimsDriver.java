...
-----------------------------------------------------------------------------
  compile:                    CodeReviewTestTimsDriver.java
  run:                        java -cp . CodeReviewTestTimsDriver
  debug:                      javac -Xlint CodeReviewTestTimsDriver.java
  version:                    javap -verbose CodeReviewTestTimsDriver | grep "major"
-----------------------------------------------------------------------------
*/
